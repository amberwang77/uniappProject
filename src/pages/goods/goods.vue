...
// 弹出层、区别哪个弹出层
const popup = ref<{
  // 弹出方式："top" | "center" | "bottom" | "left" | "right" | "message" | "dialog" | "share"
  open: (type: UniHelper.UniPopupType) => void
  close: () => void
}>()
const popupName = ref<'address' | 'service'>()
// 打开弹出层
const openPopup = (value: typeof popupName.value) => {
...
<template>
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      ...
      <view class="preview">
        <swiper circular @change="onSwiperChange">
          <swiper-item v-for="(item, index) in goodsData?.mainPictures" :key="index">
    ...
    <view class="detail panel">
      ...
      <view class="content">
        <view class="properties">
          <!-- 属性详情 -->
          <view class="item" v-for="(item, index) in goodsData?.details.properties" :key="index">
        ...
        <image
          mode="widthFix"
          v-for="(src, index) in goodsData?.details.pictures"
          :key="index"
          :src="src"
        ></image>
      </view>
    ...
    <view class="similar panel">
      ...
      <view class="content">
        <navigator
          v-for="(item, index) in goodsData?.similarProducts"
          :key="index"
          class="goods"
          hover-class="none"
          :url="`/pages/goods/goods?id=${item.picture}`"
        >
