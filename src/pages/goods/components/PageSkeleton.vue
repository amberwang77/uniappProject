  ...
  <view class="sk-container">
      ...
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-762 sk-text">128.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-902 sk-text"
            >钻石陶瓷涂层多用锅18cm 小奶锅</view
          >
          <view class="desc sk-transparent sk-text-0-0000-234 sk-text">安全耐用，易于清洗APP</view>
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-113 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-450 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-54 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-805 sk-text">
              请选择收获地址
            </text>
          </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 0px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-829 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-859 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
